class NECB2011
  ...
  def space_type_apply_internal_loads(space_type, set_people, set_lights, set_electric_equipment, set_gas_equipment, set_ventilation, set_infiltration, lights_type = 'LED', scale = 1.0, space_height = space_height)
    # Skip plenums
    ...
    # Lights
    apply_standard_lights(set_lights, space_type, space_type_properties, lights_type: lights_type, scale: 1.0, space_height: space_height)
