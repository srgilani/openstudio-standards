class NECB2011
  ...
  def space_type_apply_internal_loads(space_type, set_people, set_lights, set_electric_equipment, set_gas_equipment, set_ventilation, set_infiltration, lights_type: "NECB_Default", scale: 1.0) #Sara added lights_type and Scale
    # Skip plenums
